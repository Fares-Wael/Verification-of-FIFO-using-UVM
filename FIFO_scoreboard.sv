package FIFO_scoreboard_pkg;
    ...
    class FIFO_scoreboard extends uvm_scoreboard;
            ...
            forever begin
                ...
                if ((seq_item_sb.data_out !== data_out_ref) || (seq_item_sb.wr_ack !== wr_ack_ref) || (seq_item_sb.overflow !== overflow_ref) ||
                   ...
                   (seq_item_sb.almostempty !== almostempty_ref) || (seq_item_sb.underflow !== underflow_ref)) begin
                     ...
                     $display("At time = %0t , The queue_ref = %p",$time,queue_ref);
                     correct_count++;
                end
            end
        endtask

        task reference_model (FIFO_sequence_item seq_item_sb);
            fork
                ...
                begin: write_thread
                    if (!seq_item_sb.rst_n) begin
                       ...
                       queue_ref.delete();
                        ...
                        queue_ref.push_back(seq_item_sb.data_in);
                        wr_ack_ref = 1;
                    end else begin
                        wr_ack_ref = 0;
        ...
        function void report_phase (uvm_phase phase);
            ...
            `uvm_info ("report_phase", $sformatf("Total faild transactions : %0d", error_count), UVM_MEDIUM);
        endfunction
    endclass
endpackage